    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="{{URL::asset('assets/images/LOGO-PNG-SIN-FONDO.png')}}" width="30" alt="Fenix Networks"><span class="m-l-10">Fenix Networks</span></a>
            </div>
        </li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    @if(!\Illuminate\Support\Facades\Auth::guest())
                    <li class=""><a href="#"><i class="zmdi zmdi-calendar-check"></i><span>Agenda</span></a></li>
                    <li class="">
                    ...
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class=""><a href="#">Gestión</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Pagos</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="#">Estadisticas generales</a></li>
                            <li class=""><a href="#">Repostar pago</a></li>
                            <li class=""><a href="#">Estatus de mi pago</a></li>
                        </ul>
                    </li>
                    @endif
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            ...
                            @if(!\Illuminate\Support\Facades\Auth::guest())
                            <li class=""><a href="#">Localidades</a></li>
                    ...
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class=""><a href="#">New Post</a></li>
                            <li class=""><a href="#">Blog List</a></li>
                    ...
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class=""><a href="#">Contact list</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Widgets</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="#">Apps Widgetse</a></li>
                            <li class=""><a href="#">Data Widgetse</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Sample Pages</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="#">Blank Page</a></li>
                            <li class=""><a href="#">RTL Support</a></li>
                            <li class=""><a href="#">Image Gallery</a></li>
                            <li class=""><a href="#">Profile</a></li>
                            <li class=""><a href="#">Timeline</a></li>
                            <li class=""><a href="#">Invoices</a></li>
                    ...
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            <li class=""><a href="#">UI KIT</a></li>
                            <li class=""><a href="#">Alerts</a></li>
                            <li class=""><a href="#">Collapse</a></li>
                            <li class=""><a href="#">Colors</a></li>
                            <li class=""><a href="#">Dialogs</a></li>
                            <li class=""><a href="#">Icons</a></li>
                            <li class=""><a href="#">List Group</a></li>
                            <li class=""><a href="#">Media Object</a></li>
                            <li class=""><a href="#">Modals</a></li>
                            <li class=""><a href="#">Notifications</a></li>
                            <li class=""><a href="#">Progress Bars</a></li>
                            <li class=""><a href="#">Range Sliders</a></li>
                            <li class=""><a href="#">Sortable Nestable</a></li>
                            <li class=""><a href="#">Tabs</a></li>
                            <li class=""><a href="#">Waves</a></li>
                        </ul>
                    </li>
